angular.module('hiworkApp').component('webOrderEstimationTemplateWindowcn', {
    templateUrl: 'app/Components/WebOrderPDFTemplate/estimationTemplate_cn.html',
    bindings: {
        modalInstance: "<",
        resolve: "<"
    },
...
function invoiceTemplateController($scope, $rootScope, appSettings, AppStorage, sessionFactory, $filter, ajaxService, $http, $uibModal, $state, $stateParams, $timeout) {
    ...
    $ctrl.$onInit = function () {
        ...
        var date = new Date();
        $ctrl.CurrentDate = date.toLocaleDateString('zh-Hans', options);
        ...
        $ctrl.obj.Greeting1 = '这次承蒙您首次利用弊公司的服务，非常感谢。';
        $ctrl.obj.Greeting2 = '报价详情如下所示，烦请您进行探讨。';
        $ctrl.obj.Greeting3 = '';
        $ctrl.obj.Conclusion1 = 'We are supporting International Business and Multicultural Communication';
        $ctrl.obj.Conclusion2 = "我们活用在住外国人的网络，支援您的海外商业和国际交流。";
        $ctrl.obj.Conclusion3 = "登录员工60913名 （2018年2月8日现在)";
    };
    $ctrl.Close = function () {
