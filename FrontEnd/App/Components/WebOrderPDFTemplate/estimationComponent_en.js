angular.module('hiworkApp').component('webOrderEstimationTemplateWindowen', {
    templateUrl: 'app/Components/WebOrderPDFTemplate/estimationTemplate_en.html',
    bindings: {
        modalInstance: "<",
        resolve: "<"
    },
...
function invoiceTemplateController($scope, $rootScope, appSettings, AppStorage, sessionFactory, $filter, ajaxService, $http, $uibModal, $state, $stateParams, $timeout) {
    ...
    $ctrl.$onInit = function () {
        ...
        $ctrl.obj.Greeting1 = 'Thank you very much for choosing our service.';
        $ctrl.obj.Greeting2 = 'We are sending you the estimation as per your request.';
        $ctrl.obj.Greeting3 = 'We are looking forward for the opportunity to serve you.';
