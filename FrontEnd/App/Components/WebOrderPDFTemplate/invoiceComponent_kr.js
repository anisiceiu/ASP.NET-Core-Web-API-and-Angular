angular.module('hiworkApp').component('webOrderInvoiceTemplateWindowkr', {
    templateUrl: 'app/Components/WebOrderPDFTemplate/invoiceTemplate_kr.html',
    bindings: {
        modalInstance: "<",
        resolve: "<"
    },
...
function invoiceTemplateController($scope, $rootScope, appSettings, AppStorage, sessionFactory, $filter, ajaxService, $http, $uibModal, $state, $stateParams, $timeout) {
    ...
    $ctrl.$onInit = function () {
        ...
        $ctrl.obj.Greeting1 = 'Thank you very much for using our service this time.';
        $ctrl.obj.Greeting2 = 'We will charge your request as below.';
        $ctrl.obj.Greeting3 = 'I would like to ask for your continued support next time, thank you.';
        $ctrl.obj.Conclusion1 = 'We are supporting International Business and Multicultural Communication';
        $ctrl.obj.Conclusion2 = "저희는 외국인 네트워크를 활용하여 해외 비즈니스와 국제교류를 서포트합니다.";
